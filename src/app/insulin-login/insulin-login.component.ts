...
@Component({
  selector: 'app-insulin-login',
  templateUrl: './insulin-login.component.html',
  styleUrls: ['./insulin-login.component.scss'],
})
export class InsulinLoginComponent implements OnInit {
  email: string;
  password: string;
  submitted = false;
  loginForm: FormGroup;
  ...
  login() {
    ...
    this.sessionService
      ...
      .subscribe(result => {
        ...
        localStorage.setItem('insulinPortal', 'true');
