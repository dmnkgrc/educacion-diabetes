...
@Component({
  selector: 'app-insulin-courses',
  templateUrl: './insulin-courses.component.html',
  styleUrls: ['./insulin-courses.component.scss'],
})
export class InsulinCoursesComponent implements OnInit {
  courses: any;
