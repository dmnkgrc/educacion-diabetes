...
export class MessageService {
  ...
  public getInbox(userId): Observable<any> {
    ...
    return this.http
      .get(this.rootURL + this.messagesEndpoint + `${userId}/received`, {
        headers,
      })
      .pipe(
        tap((res: any) => {
  ...
  public getSentMessages(userId: any): Observable<any> {
    ...
    return this.http
      .get(this.rootURL + this.messagesEndpoint + `${userId}/sent`, { headers })
      .pipe(
        tap((res: any) => {
          console.log(res);
        })
  ...
  public createMessage(data: any): Observable<any> {
    ...
    return this.http
      .post(this.rootURL + this.messagesEndpoint, data, { headers })
      .pipe(
        tap((res: any) => {
          console.log(res);
        }),
  ...
  public createCourseMessage(data: any): Observable<any> {
    ...
    return this.http
      .post(this.rootURL + this.messagesEndpoint + 'courses', data, { headers })
      .pipe(
        tap((res: any) => {
          console.log(res);
        }),
